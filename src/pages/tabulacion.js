                ...
                <tr data-alumno-id="${alumno.id}">
                  ...
                  <td title="${alumno.nombre}">
                    <div style="display: flex; align-items: center; justify-content: space-between; width: 100%; gap: 0.5rem;">
                        <span style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${alumno.nombre}</span>
                        <button class="icon-btn btn-dictar" data-alumno="${alumno.id}" title="Dictar Respuestas con IA" style="padding: 0.35rem; flex-shrink: 0; display: flex;">
